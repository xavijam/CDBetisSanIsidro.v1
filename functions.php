  ...
  function firstBlock() {
    if (seasonOrNot()) {
      ...
      echo '<div class="block top_left socio">
              ...
              <p>Ya está abierta la inscripción de la temporada 12/13, para más información pincha <a href="/socio">aquí</a>.</p>
  ...
  function fifthBlock() {
    if (seasonOrNot()) {
      echo '<div class="block sponsors">
              ...
              <div class="outer_block">
                <div class="inner_block">
                  <a href="http://www.futuroscracks.com" class="futuros_cracks" target="_blank">Futuros Cracks</a>
