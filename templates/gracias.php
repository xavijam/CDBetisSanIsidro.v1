...
<html <?php language_attributes(); ?>>
    ...
    <div class="short">
      <a class="logo" title="Volver al inicio" href="/">Inicio</a>
  		<div class="top">
  		  <h1 class="thanks">Gracias por registrarte</h1>
  		</div>
  		<div class="middle">
  		  <p class="info">En breve recibirás un email con las últimas instrucciones ( si no lo encuentras recuerda mirar la carpeta spam ).</p>
