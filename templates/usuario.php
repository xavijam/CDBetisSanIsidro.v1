...
?>
        ...
        <?php
                 global $userdata;
                 get_currentuserinfo();
                 echo  'Tu último login fue: ';
                 get_last_login($userdata->ID);
        ?>
        </span>
        
        <span style="float:left;width:100%">
          <?php echo 'Número de comentarios: '.count_user_comments($userdata->ID)?>
        </span>
        
        <span style="float:left;width:100%">
          <?php userphoto_thumbnail($userdata);?>
        </span>
        
        <span style="float:left;width:100%">
          <?php echo 'Hay '.countComments().' comentarios en el site';?>
        </span>
            ...
            <form name="profile" action="" method="post" enctype="multipart/form-data">
              ...
              <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <?php if ( isset($_GET['updated']) ):
                  $d_url = $_GET['d'];?>
                <tr>
                  <td align="center" colspan="2"><span style="color: #FF0000; font-size: 11px;">Tus datos han sido guardados</span></td>
                </tr>
                <?php elseif($errmsg!=""): ?>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="file" name="userphoto_image_file" id="userphoto_image_file" style="width:300px" /></td>
                </tr>
